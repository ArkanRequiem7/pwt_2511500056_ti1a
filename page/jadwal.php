                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?= $data['semester'] == 1 ? '1 (Ganjil)' : '2 (Genap)'; ?></td>
                            <td class="text-center">
                                ...
                                <a href="index.php?page=hapus_jadwal&id_kelas=<?= $data['id_kelas']; ?>&aksi=hapus_grup" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus seluruh jadwal kelas ini?')">
